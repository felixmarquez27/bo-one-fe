...
export type { InputAdornmentProps } from './InputAdornment/InputAdornment';
...
export type { DialogTitleProps } from './DialogTitle/DialogTitle';

// DialogContent
export { DialogContent } from './DialogContent/DialogContent';
export type { DialogContentProps } from './DialogContent/DialogContent';

// DialogActions
export { DialogActions } from './DialogActions/DialogActions';
export type { DialogActionsProps } from './DialogActions/DialogActions';
